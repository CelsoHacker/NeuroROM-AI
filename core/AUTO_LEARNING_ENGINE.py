...
class AutoLearningEngine:
    ...
    def discover_candidates(self) -> List[TextItem]:
        ...
        # Method 1: ASCII scan
        items.extend(self._scan_ascii_regions(seen_offsets))
    ...
    def _scan_ascii_regions(self, seen_offsets: Set[int]) -> List[TextItem]:
        ...
        while i < self.rom_size:
            ...
            j = i
            while j < self.rom_size and 0x20 <= self.rom_data[j] <= 0x7E:
                j += 1
