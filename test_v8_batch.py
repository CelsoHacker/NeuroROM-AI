...
# -*- coding: utf-8 -*-
"""
Teste Comparativo V8.0 - Execução em Lote
Roda o extrator V8.0 em múltiplas ROMs e gera relatório comparativo
"""
...
from extraction.extrator_universal_v8 import ExtratorUniversalV8

def test_rom(rom_path, output_dir):
    """
    Testa uma ROM com o V8.0
    ...
    try:
        # Cria extrator
        extrator = ExtratorUniversalV8(str(rom_path))
...
def gerar_relatorio_comparativo(resultados, output_path):
    ...
    with open(output_path, 'w', encoding='utf-8') as f:
        f.write("="*80 + "\n")
        f.write("RELATÓRIO COMPARATIVO - EXTRATOR V8.0\n")
...
def main():
    ...
    print("\n" + "="*80)
    print("🧪 TESTE COMPARATIVO V8.0 - Execução em Lote")
    print("="*80 + "\n")
    ...
    relatorio_path = output_dir / f"relatorio_comparativo_v8_{timestamp}.txt"
